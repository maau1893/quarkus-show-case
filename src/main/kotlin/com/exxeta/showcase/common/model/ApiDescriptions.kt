...
object ApiDescriptions {
    ...
    const val POST_TODO = "Creates a new Todo and returns the database entity, including id and timestamps."
    const val PUT_TODO = "Updates a Todo for the given id and request body."
